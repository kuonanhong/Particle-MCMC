...
# read in data
root = "/home/taylor/ssm/mcmc/output/sisr_pitt_shep_1k_1k/"
third = os.path.join(root, "sisr_pitt_shep_1k_1k.csv")
...
pd.tools.plotting.scatter_matrix(derp[:200], alpha=0.2)
