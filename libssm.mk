...
ObjectsFileList        :="libssm.txt"
PCHCompileFlags        :=
MakeDirCommand         :=mkdir -p
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)/home/taylor/ssm/include $(IncludeSwitch)/home/taylor/ssm/include2 $(IncludeSwitch)/usr/include/eigen3 
IncludePCH             := 
RcIncludePath          := 
Libs                   := 
ArLibs                 :=  
...
$(OutputFile): $(Objects)
	...
	@echo rebuilt > "/home/taylor/Documents/ssmworkspace/.build-debug/libssm"
