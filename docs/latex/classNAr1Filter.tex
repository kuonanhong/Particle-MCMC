...
\hline
{\em resamp\+Technique} & the style of resampling you want. \\
\hline
{\em path\+Length} & the path\+Length you want (just set it to zero unless you have a good reason not to) \\
\hline
\end{DoxyParams}
...
\subsubsection[{\texorpdfstring{q1\+Samp(const Vec \&y1)}{q1Samp(const Vec &y1)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Vec} N\+Ar1\+Filter\+::q1\+Samp (
\begin{DoxyParamCaption}
\item[{const {\bf Vec} \&}]{y1}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{q\+Samp(const Vec \&xtm1, const Vec \&yt)}{qSamp(const Vec &xtm1, const Vec &yt)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Vec} N\+Ar1\+Filter\+::q\+Samp (
\begin{DoxyParamCaption}
\item[{const {\bf Vec} \&}]{xtm1, }
\item[{const {\bf Vec} \&}]{yt}
\end{DoxyParamCaption}
