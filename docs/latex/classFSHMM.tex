...
\subsubsection[{\texorpdfstring{update(const Vec \&yt, const Vec \&cond\+Dens\+Vec)}{update(const Vec &yt, const Vec &condDensVec)}}]{\setlength{\rightskip}{0pt plus 5cm}void F\+S\+H\+M\+M\+::update (
\begin{DoxyParamCaption}
\item[{const {\bf Vec} \&}]{yt, }
\item[{const {\bf Vec} \&}]{cond\+Dens\+Vec}
\end{DoxyParamCaption}
)}\hypertarget{classFSHMM_a6a9c239a6de129579cc659269c6bc03f}{}\label{classFSHMM_a6a9c239a6de129579cc659269c6bc03f}
