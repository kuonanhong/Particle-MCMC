...
\item[{int}]{num\+Parts, }
\item[{const Mat \&}]{beta, }
\item[{const Vec \&}]{R\+\_\+sigmas\+\_\+as\+\_\+vec, }
\item[{const Vec \&}]{mus, }
\item[{const Vec \&}]{phis, }
...
\subsubsection[{\texorpdfstring{f\+Samp(const Vec \&xtm1)}{fSamp(const Vec &xtm1)}}]{\setlength{\rightskip}{0pt plus 5cm}Vec Jac\+Et\+Al\+A\+P\+F\+::f\+Samp (
\begin{DoxyParamCaption}
\item[{const Vec \&}]{xtm1}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{get\+Predictive\+Var() const }{getPredictiveVar() const }}]{\setlength{\rightskip}{0pt plus 5cm}Mat Jac\+Et\+Al\+A\+P\+F\+::get\+Predictive\+Var (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{prop\+Mu(const Vec \&xtm1)}{propMu(const Vec &xtm1)}}]{\setlength{\rightskip}{0pt plus 5cm}Vec Jac\+Et\+Al\+A\+P\+F\+::prop\+Mu (
\begin{DoxyParamCaption}
\item[{const Vec \&}]{xtm1}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{q1\+Samp(const Vec \&y1)}{q1Samp(const Vec &y1)}}]{\setlength{\rightskip}{0pt plus 5cm}Vec Jac\+Et\+Al\+A\+P\+F\+::q1\+Samp (
\begin{DoxyParamCaption}
\item[{const Vec \&}]{y1}
\end{DoxyParamCaption}
