...
\index{Pmmh\+\_\+jac\+\_\+apf@{Pmmh\+\_\+jac\+\_\+apf}!Pmmh\+\_\+jac\+\_\+apf@{Pmmh\+\_\+jac\+\_\+apf}}
\subsubsection[{\texorpdfstring{Pmmh\+\_\+jac\+\_\+apf(unsigned int num\+Parts, std\+::vector$<$ double $>$ start\+Theta, unsigned int num\+M\+C\+M\+C\+Iters, const std\+::string \&data\+File, unsigned int num\+Cols, bool mc)}{Pmmh_jac_apf(unsigned int numParts, std::vector< double > startTheta, unsigned int numMCMCIters, const std::string &dataFile, unsigned int numCols, bool mc)}}]{\setlength{\rightskip}{0pt plus 5cm}Pmmh\+\_\+jac\+\_\+apf\+::\+Pmmh\+\_\+jac\+\_\+apf (
...
)}\hypertarget{classPmmh__jac__apf_a10d1ff1b6f508a1b9a9492e6bf8a563b}{}\label{classPmmh__jac__apf_a10d1ff1b6f508a1b9a9492e6bf8a563b}
