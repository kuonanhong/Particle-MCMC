...
\subsubsection[{\texorpdfstring{f\+Samp(const Vec \&xtm1)}{fSamp(const Vec &xtm1)}}]{\setlength{\rightskip}{0pt plus 5cm}Vec S\+Vol\+A\+P\+F\+Filter\+::f\+Samp (
\begin{DoxyParamCaption}
\item[{const Vec \&}]{xtm1}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{prop\+Mu(const Vec \&xtm1)}{propMu(const Vec &xtm1)}}]{\setlength{\rightskip}{0pt plus 5cm}Vec S\+Vol\+A\+P\+F\+Filter\+::prop\+Mu (
\begin{DoxyParamCaption}
\item[{const Vec \&}]{xtm1}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{q1\+Samp(const Vec \&y1)}{q1Samp(const Vec &y1)}}]{\setlength{\rightskip}{0pt plus 5cm}Vec S\+Vol\+A\+P\+F\+Filter\+::q1\+Samp (
\begin{DoxyParamCaption}
\item[{const Vec \&}]{y1}
\end{DoxyParamCaption}
