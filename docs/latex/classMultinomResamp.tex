...
\hline
\end{DoxyParams}
\index{Multinom\+Resamp@{Multinom\+Resamp}!ressamp\+H\+R\+B\+PF@{ressamp\+H\+R\+B\+PF}}
\index{ressamp\+H\+R\+B\+PF@{ressamp\+H\+R\+B\+PF}!Multinom\+Resamp@{Multinom\+Resamp}}
\subsubsection[{\texorpdfstring{ressamp\+H\+R\+B\+P\+F(std\+::vector$<$ F\+S\+H\+M\+M $>$ \&old\+Mods, std\+::vector$<$ Vec $>$ \&old\+Samps, std\+::vector$<$ double $>$ \&old\+Wts)}{ressampHRBPF(std::vector< FSHMM > &oldMods, std::vector< Vec > &oldSamps, std::vector< double > &oldWts)}}]{\setlength{\rightskip}{0pt plus 5cm}void Multinom\+Resamp\+::ressamp\+H\+R\+B\+PF (
\begin{DoxyParamCaption}
\item[{std\+::vector$<$ {\bf F\+S\+H\+MM} $>$ \&}]{old\+Mods, }
\item[{std\+::vector$<$ {\bf Vec} $>$ \&}]{old\+Samps, }
\item[{std\+::vector$<$ double $>$ \&}]{old\+Wts}
\end{DoxyParamCaption}
)}\hypertarget{classMultinomResamp_aaddcbec4eb62954d8d7aa96c45ffd7d0}{}\label{classMultinomResamp_aaddcbec4eb62954d8d7aa96c45ffd7d0}
