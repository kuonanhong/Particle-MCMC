...
\subsubsection[{\texorpdfstring{k\+Gen(const std\+::vector$<$ double $>$ \&log\+First\+Stage\+Weights)}{kGen(const std::vector< double > &logFirstStageWeights)}}]{\setlength{\rightskip}{0pt plus 5cm}std\+::vector$<$unsigned int$>$ Multinom\+Resamp\+::k\+Gen (
\begin{DoxyParamCaption}
\item[{const std\+::vector$<$ double $>$ \&}]{log\+First\+Stage\+Weights}
\end{DoxyParamCaption}
)}\hypertarget{classMultinomResamp_a74c84e7b6b88eb1f6e1a0c77d734d7cf}{}\label{classMultinomResamp_a74c84e7b6b88eb1f6e1a0c77d734d7cf}
