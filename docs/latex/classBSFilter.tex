...
\subsubsection[{\texorpdfstring{f\+Samp(const Vec \&xtm1)=0}{fSamp(const Vec &xtm1)=0}}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf Vec} B\+S\+Filter\+::f\+Samp (
\begin{DoxyParamCaption}
\item[{const {\bf Vec} \&}]{xtm1}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}\hypertarget{classBSFilter_ad1cc178c82a518832200949ca4e3d6f6}{}\label{classBSFilter_ad1cc178c82a518832200949ca4e3d6f6}
